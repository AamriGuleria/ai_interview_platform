...
class Interview(Base):
    ...
    resume_validation = Column(JSONB, nullable=True)
...
class InterviewQuestion(Base):
    ...
    resume_distance = Column(Float, nullable=True)
    resume_similarity = Column(Float, nullable=True)
    retrieval_distance = Column(Float, nullable=True)
